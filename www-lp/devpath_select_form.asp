<html><head><script type="text/javascript" src="general.js"></script><script type="text/javascript">var modemInfo;
...
</script><style type="text/css">.sel_devpath{
...
</style></head><body onload="return get_html()"><div id="tb1" style="text-align:center; vertical-align:middle; font-size:32px;">Please wait...</div></body></html>
